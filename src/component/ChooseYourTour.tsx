    ...
    return (
        <div
            ...
            className={`
                ...
                transform opacity-0 translate-y-10 group h-[300px] md:h-[350px]
            `}
        >
        {/* Background Image */}
        <div
            className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110 rounded-[10px]"
            style={{ 
        ...
        <div className="absolute inset-0 bg-[#413b2a] opacity-0 transition-opacity duration-300 group-hover:opacity-70"></div>

            {/* Content Container */}
            <div className="absolute inset-0 py-2 px-6 flex flex-col justify-end items-start transition-all duration-300 group-hover:justify-center group-hover:items-center">
                {/* Title */}
                <h3 className="text-white text-3xl font-normal transition-all duration-500 origin-bottom-left translate-x-0 group-hover:text-4xl group-hover:text-center group-hover:translate-x-0 drop-shadow-lg group-hover:font-semibold">
                    {title}
                </h3>

                {/* Description - Hidden by default, visible on hover */}
                <p className="text-white opacity-0 mt-6 max-h-0 overflow-hidden group-hover:opacity-100 group-hover:max-h-[200px] text-center text-xl w-full drop-shadow-md">
                    {description}
                </p>
            </div>
        </div>
