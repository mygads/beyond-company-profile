...
const ContactUsPartnership: React.FC = () => {
        ...
        >
            ...
            <div className="container mx-auto relative z-10">
                <div className="flex flex-col md:flex-row items-center">
                    ...
                    <div
                        ref={contentRef}
                        className="md:w-1/3 mb-8 md:mb-0 md:pr-8 transition-all duration-700 ease-out transform opacity-0 translate-x-[-20px] flex flex-row justify-center text-white items-center gap-8"
                    >
...
export default ContactUsPartnership
